...
select codigo, left(nif,8) as dni, right(nif,1) as nif_letter from empleado;
...
select nombre, presupuesto-gastos as saldo from departamento;

-- 12. Lista el nombre de los departamentos y el valor del presupuesto actual ordenado de forma ascendente. 
select nombre, presupuesto-gastos as saldo from departamento order by saldo asc;
...
/* 21. Devuelve una lista con el nombre de los departamentos y el presupuesto, de aquellos que tienen un presupuesto mayor
		o igual a 150000 euros. */
