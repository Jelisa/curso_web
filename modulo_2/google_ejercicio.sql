...
primera página?*/
select nombre, descripcion, url from resultado limit 5;

-- 2. ¿Qué consulta necesitaríamos para mostrar resultados de la segunda página?
select nombre, descripcion, url from resultado limit 5, 5;

-- 3. ¿Y los resultados de la tercera página?
select nombre, descripcion, url from resultado limit 10, 5;